...
// <div className="container px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto mt-10 md:mt-32">
//   <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 gap-3 lg:gap-5">

//     <div className="p-2 md:p-0 shadow border border-primary-orange-200 rounded-lg ">
//       <Image className='py-3 lg:py-5 w-16 h-auto md:w-20 lg:w-24 mx-auto' src={brand1} width={100} height={100} />
//     </div>
// </div>
// </div>
